...
V2q <- AAV2$arma[[2]]
V2d <- AAV2$arma[[5]]
AAV2l <- auto.arima(S1V2, max.order = 20L, ic = 'aicc', stepwise = FALSE,
                   approximation = FALSE, seasonal = FALSE, parallel = TRUE,
...
```{r V1plot, echo=FALSE}
plot(forecast(AAV1, h = 140), main = "Forecast for V1")
plot(forecast(AAV2l, h = 140, lambda = AAV2l$lambda[[1]], biasadj = TRUE),
