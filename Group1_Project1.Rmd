...
#### Exploratory Analysis of Var02 in series S02
...
Looking at above plots and comparing with the below assumptions for univariate variable.                                  
...
In Var02 case, the run sequence plot shows the order that the data are presented in 
the file is NOT random and also the variance in the data is eventually not much towards
the end i.e. it is flat and drift is nearly constant. Lag plot has some structure,
i.e., mostly a  big clusters is  visible which means it is not random. Histogram shows the
presence of outliers. The histogram is not symmetrical, nor does it  looks like a 
bell-curve and it is right skewed. The normal QQ plot is not a straight line.

#### Exploratory Analysis of Var03 in series S02
