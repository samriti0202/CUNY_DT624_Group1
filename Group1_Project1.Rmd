...
Both series exhibited small changes in variance, so a Box-Cox transformation
was performed on both series.
...
```{r, echo=FALSE}
autoplot(forecast(S4V1_boxed_autoarima, h = 140), main = "Forecast of V1 from ARIMA(0,1,1)")
autoplot(forecast(S4V2_boxed_outliers_autoarima, h = 140, biasadj = TRUE),
     main = "Forecast of V2 from ARIMA(3,1,1)")
```
