...
### Forecasts
After the analysis detailed in the appendix, the selected models for the data
are a ARIMA(`r S5V2lp`, `r S5V2ld`, `r S5V2lq`) model with
\(\lambda=\)`r AAS5V2l$lambda[[1]]` for V2 and XXXX for V2. Plots of the
forecasts are below.
