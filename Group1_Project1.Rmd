...
AAV1 <- auto.arima(S1V1, max.order = 20L, ic = 'aicc', stepwise = FALSE,
                   approximation = FALSE, allowdrift = TRUE, seasonal = FALSE,
                   parallel = TRUE)
...
V2q <- AAV2$arma[[2]]
V2d <- AAV2$arma[[5]]
AAV1b <- auto.arima(S1V1, max.order = 5L, ic = 'aicc', stepwise = FALSE,
                   approximation = FALSE, allowdrift = TRUE, seasonal = FALSE,
                   parallel = TRUE)
AAV2b <- auto.arima(S1V2, max.order = 5L, ic = 'aicc', stepwise = FALSE,
                   approximation = FALSE, allowdrift = TRUE, seasonal = FALSE,
                   parallel = TRUE)
V1bp <- AAV1b$arma[[1]]
V1bq <- AAV1b$arma[[2]]
...
### Transformations
After much analysis, V1 was modeled with neither outlier replacement nor
...
The new differnced data is stationary and therefore appropriate for ARIMA
...
the total order of the ARIMA model will be constrained to 5, and tried again.
