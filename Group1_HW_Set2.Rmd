...
fitControl <- trainControl(method = "repeatedcv", number = 11L, repeats = 5L,
                           allowParallel = TRUE)
nnGrid <- expand.grid(decay = c(0, 1e-2, 1e-1), size = 1:4, bag = c(FALSE, TRUE))
set.seed(12)
...
The optimal model's statistics on the traun
